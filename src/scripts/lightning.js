...
5. Run `grunt` to start your json-server and your http-server (and good old es-lint)
*/
...
/*
  ...
  1. In your coffee shop application, Once the POST has been completed successfully (i.e. in the .then()), you should GET all of the coffee drinks in the database and print them to the DOM
...
// Lightning Exercise 2: Write a factory function that creates and returns an object that represents a pet.The function should accept two arguments.
